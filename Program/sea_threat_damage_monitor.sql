...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2024 at 12:32 PM
...
--
ALTER TABLE `admin`
  MODIFY `ID_Admin` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2147010210;

--
-- AUTO_INCREMENT for table `aduan`
--
ALTER TABLE `aduan`
  MODIFY `ID_Aduan` int(40) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;

--
-- AUTO_INCREMENT for table `data_kerusakan`
--
ALTER TABLE `data_kerusakan`
  MODIFY `ID_data` int(40) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
